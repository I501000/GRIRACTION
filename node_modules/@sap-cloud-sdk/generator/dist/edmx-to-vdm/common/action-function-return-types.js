...
exports.isEntityNotDeserializable = exports.parseActionImportReturnTypes = exports.parseFunctionImportReturnTypes = void 0;
 ...
 * @internal
 */
function parseFunctionImportReturnTypes(returnType, entities, complexTypes, extractResponse, serviceName) {
    return parseReturnTypes(returnType, entities, complexTypes, extractResponse, serviceName);
}
exports.parseFunctionImportReturnTypes = parseFunctionImportReturnTypes;
/**
 * @internal
 */
function parseActionImportReturnTypes(returnType, entities, complexTypes, extractResponse, serviceName) {
    return parseReturnTypes(returnType, entities, complexTypes, extractResponse, serviceName);
}
exports.parseActionImportReturnTypes = parseActionImportReturnTypes;
function parseReturnTypes(returnType, entities, complexTypes, extractResponse, serviceName) {
    if (!returnType) {
    ...
    throw Error(`Unable to find a return type for name ${JSON.stringify(returnType)}.`);
}
...
function findComplexType(returnType, complexTypes) {
    returnType = (0, edmx_to_vdm_util_1.parseTypeName)(returnType);
    return complexTypes.find(e => `${e.namespace}.${e.originalName}` === returnType);
}
...
//# sourceMappingURL=action-function-return-types.js.map