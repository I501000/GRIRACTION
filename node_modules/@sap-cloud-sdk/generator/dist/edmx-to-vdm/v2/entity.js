...
function generateEntitiesV2(serviceMetadata, complexTypes, formatter) {
    const entitySets = (0, v2_1.parseEntitySetsV2)(serviceMetadata.edmx.root);
    const entityTypes = (0, v2_1.parseEntityTypes)(serviceMetadata.edmx.root);
    ...
    const associations = joinAssociationMetadata((0, v2_1.parseAssociationSets)(serviceMetadata.edmx.root), (0, v2_1.parseAssociation)(serviceMetadata.edmx.root));
