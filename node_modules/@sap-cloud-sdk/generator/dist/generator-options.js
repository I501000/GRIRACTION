...
exports.generatorOptionsCli = exports.defaultValueProcessesJsGeneration = void 0;
...
exports.generatorOptionsCli = {
    ...
    generateNpmrc: {
        describe: 'Deprecated. If set to true the generator will generate an .npmrc file specifying a registry for @sap scoped dependencies. This is not necessary anymore and will be skipped by default.',
        type: 'boolean',
        default: false
    },
    generatePackageJson: {
    ...
    licenseInPackageJson: {
        describe: "License to be used on the generated package.json. Only considered is 'generatePackageJson' is enabled.",
        type: 'string',
        requiresArg: false
    },
    generateJs: {
