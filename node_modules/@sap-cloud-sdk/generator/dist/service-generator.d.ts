 ...
 * @internal
 */
export declare function parseAllServices(options: GeneratorOptions): VdmServiceMetadata[];
/**
 ...
 * @internal
 */
export declare function parseService(serviceDefinitionPaths: ServiceDefinitionPaths, options: GeneratorOptions, mappings: VdmMapping, globalNameFormatter: GlobalNameFormatter): VdmServiceMetadata;
/**
 * @internal
 */
