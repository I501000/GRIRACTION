...
function getWriteRequestType(service) {
    return service.entities
        .map(e => `CreateRequestBuilder<${e.className}<DeSerializersT>, DeSerializersT> | UpdateRequestBuilder<${e.className}<DeSerializersT>, DeSerializersT> | DeleteRequestBuilder<${e.className}<DeSerializersT>, DeSerializersT>`)
        .join(' | ');
}
function getReadRequestType(service) {
    return Array.prototype
        .concat(service.entities.map(e => `GetAllRequestBuilder<${e.className}<DeSerializersT>, DeSerializersT>`), service.entities.map(e => `GetByKeyRequestBuilder<${e.className}<DeSerializersT>, DeSerializersT>`))
        .join('|');
}
