...
class ServiceNameFormatter {
    ...
    originalToFunctionImportName(str) {
        const transformedName = voca_1.default.camelCase(str);
    ...
    originalToActionImportName(str) {
        return this.originalToFunctionImportName(str);
    }
    originalToComplexTypeName(str) {
        const transformedName = stripAUnderscore(voca_1.default.titleCase(str)).replace('_', '');
        return this.serviceWideNameGenerator.generateAndSaveUniqueName(transformedName, false);
    }
    originalToEnumTypeName(str) {
