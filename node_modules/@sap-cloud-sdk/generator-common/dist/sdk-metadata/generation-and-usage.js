...
exports.usageHeaderText = exports.getGenerationSteps = void 0;
/**
 * @internal
 */
function getGenerationSteps(installCommand, generateCommand, generationDocLink, apiType) {
    const anchor = apiType === 'OData' ? '#options' : '#options-of-the-openapi-cli';
    return {
...
<li>Download the API specification from the Overview -&gt; API Specification section. ${apiType === 'OData' ? 'Choose EDMX format.' : 'Choose JSON format.'}</li>
...
exports.getGenerationSteps = getGenerationSteps;
/**
 * @internal
 */
