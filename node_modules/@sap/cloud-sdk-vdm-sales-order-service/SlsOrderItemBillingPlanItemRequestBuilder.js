...
/**
 * Request builder class for operations supported on the [[SlsOrderItemBillingPlanItem]] entity.
 */
class SlsOrderItemBillingPlanItemRequestBuilder extends odata_v2_1.RequestBuilder {
     ...
     * @param salesOrder Key property. See [[SlsOrderItemBillingPlanItem.salesOrder]].
     * @param salesOrderItem Key property. See [[SlsOrderItemBillingPlanItem.salesOrderItem]].
     * @param billingPlan Key property. See [[SlsOrderItemBillingPlanItem.billingPlan]].
     * @param billingPlanItem Key property. See [[SlsOrderItemBillingPlanItem.billingPlanItem]].
    ...
    delete(salesOrderOrEntity, salesOrderItem, billingPlan, billingPlanItem) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, salesOrderOrEntity instanceof SlsOrderItemBillingPlanItem_1.SlsOrderItemBillingPlanItem ? salesOrderOrEntity : {
