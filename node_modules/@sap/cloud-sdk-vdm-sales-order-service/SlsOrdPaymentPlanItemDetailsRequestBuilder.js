...
/**
 * Request builder class for operations supported on the [[SlsOrdPaymentPlanItemDetails]] entity.
 */
class SlsOrdPaymentPlanItemDetailsRequestBuilder extends odata_v2_1.RequestBuilder {
     ...
     * @param salesOrder Key property. See [[SlsOrdPaymentPlanItemDetails.salesOrder]].
     * @param paymentPlanItem Key property. See [[SlsOrdPaymentPlanItemDetails.paymentPlanItem]].
    ...
    delete(salesOrderOrEntity, paymentPlanItem) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, salesOrderOrEntity instanceof SlsOrdPaymentPlanItemDetails_1.SlsOrdPaymentPlanItemDetails ? salesOrderOrEntity : {
