...
class SalesOrderPrecdgProcFlowApi {
    ...
    get schema() {
        const fieldBuilder = new odata_v2_1.FieldBuilder(SalesOrderPrecdgProcFlow_1.SalesOrderPrecdgProcFlow, this.deSerializers);
        return {
            /**
         ...
         */
            ...
            /**
             * Static representation of the [[precedingDocument]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            PRECEDING_DOCUMENT: fieldBuilder.buildEdmTypeField('PrecedingDocument', 'Edm.String', true),
            /**
             * Static representation of the [[precedingDocumentCategory]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
