...
/**
 * Request builder class for operations supported on the [[SalesOrderHeaderPrElement]] entity.
 */
class SalesOrderHeaderPrElementRequestBuilder extends odata_v2_1.RequestBuilder {
     ...
     * @param salesOrder Key property. See [[SalesOrderHeaderPrElement.salesOrder]].
     * @param pricingProcedureStep Key property. See [[SalesOrderHeaderPrElement.pricingProcedureStep]].
     * @param pricingProcedureCounter Key property. See [[SalesOrderHeaderPrElement.pricingProcedureCounter]].
    ...
    delete(salesOrderOrEntity, pricingProcedureStep, pricingProcedureCounter) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, salesOrderOrEntity instanceof SalesOrderHeaderPrElement_1.SalesOrderHeaderPrElement ? salesOrderOrEntity : {
