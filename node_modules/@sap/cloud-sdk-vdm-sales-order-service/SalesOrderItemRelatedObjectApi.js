...
class SalesOrderItemRelatedObjectApi {
    ...
    get schema() {
        const fieldBuilder = new odata_v2_1.FieldBuilder(SalesOrderItemRelatedObject_1.SalesOrderItemRelatedObject, this.deSerializers);
        return {
            /**
         ...
         */
            ...
            /**
             * Static representation of the [[sdDocRelatedObjectSequenceNmbr]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            SD_DOC_RELATED_OBJECT_SEQUENCE_NMBR: fieldBuilder.buildEdmTypeField('SDDocRelatedObjectSequenceNmbr', 'Edm.String', false),
            /**
             * Static representation of the [[sdDocumentRelatedObjectType]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            SD_DOCUMENT_RELATED_OBJECT_TYPE: fieldBuilder.buildEdmTypeField('SDDocumentRelatedObjectType', 'Edm.String', true),
            /**
             * Static representation of the [[sdDocRelatedObjectSystem]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            SD_DOC_RELATED_OBJECT_SYSTEM: fieldBuilder.buildEdmTypeField('SDDocRelatedObjectSystem', 'Edm.String', true),
            /**
             * Static representation of the [[sdDocRelatedObjectReference1]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            SD_DOC_RELATED_OBJECT_REFERENCE_1: fieldBuilder.buildEdmTypeField('SDDocRelatedObjectReference1', 'Edm.String', true),
            /**
             * Static representation of the [[sdDocRelatedObjectReference2]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
