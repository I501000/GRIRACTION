...
class SalesOrderItemPartnerAddressApi {
    ...
    get schema() {
        const fieldBuilder = new odata_v2_1.FieldBuilder(SalesOrderItemPartnerAddress_1.SalesOrderItemPartnerAddress, this.deSerializers);
        return {
            /**
         ...
         */
            ...
            /**
             * Static representation of the [[mobilePhoneCountry]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            MOBILE_PHONE_COUNTRY: fieldBuilder.buildEdmTypeField('MobilePhoneCountry', 'Edm.String', true),
            /**
             * Static representation of the [[mobileNumber]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            MOBILE_NUMBER: fieldBuilder.buildEdmTypeField('MobileNumber', 'Edm.String', true),
            /**
             * Static representation of the [[phoneNumberCountry]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            ...
            /**
             * Static representation of the [[phoneExtensionNumber]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            PHONE_EXTENSION_NUMBER: fieldBuilder.buildEdmTypeField('PhoneExtensionNumber', 'Edm.String', true),
            /**
             * Static representation of the [[faxNumberCountry]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            FAX_NUMBER_COUNTRY: fieldBuilder.buildEdmTypeField('FaxNumberCountry', 'Edm.String', true),
            /**
             * Static representation of the [[faxAreaCodeSubscriberNumber]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            FAX_AREA_CODE_SUBSCRIBER_NUMBER: fieldBuilder.buildEdmTypeField('FaxAreaCodeSubscriberNumber', 'Edm.String', true),
            /**
             * Static representation of the [[faxExtensionNumber]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
