...
/**
 * Request builder class for operations supported on the [[SalesOrderItemPrElement]] entity.
 */
class SalesOrderItemPrElementRequestBuilder extends odata_v2_1.RequestBuilder {
     ...
     * @param salesOrder Key property. See [[SalesOrderItemPrElement.salesOrder]].
     * @param salesOrderItem Key property. See [[SalesOrderItemPrElement.salesOrderItem]].
     * @param pricingProcedureStep Key property. See [[SalesOrderItemPrElement.pricingProcedureStep]].
     * @param pricingProcedureCounter Key property. See [[SalesOrderItemPrElement.pricingProcedureCounter]].
    ...
    delete(salesOrderOrEntity, salesOrderItem, pricingProcedureStep, pricingProcedureCounter) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, salesOrderOrEntity instanceof SalesOrderItemPrElement_1.SalesOrderItemPrElement ? salesOrderOrEntity : {
