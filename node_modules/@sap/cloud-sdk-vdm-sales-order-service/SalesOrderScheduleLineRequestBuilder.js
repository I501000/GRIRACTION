...
/**
 * Request builder class for operations supported on the [[SalesOrderScheduleLine]] entity.
 */
class SalesOrderScheduleLineRequestBuilder extends odata_v2_1.RequestBuilder {
     ...
     * @param salesOrder Key property. See [[SalesOrderScheduleLine.salesOrder]].
     * @param salesOrderItem Key property. See [[SalesOrderScheduleLine.salesOrderItem]].
     * @param scheduleLine Key property. See [[SalesOrderScheduleLine.scheduleLine]].
    ...
    delete(salesOrderOrEntity, salesOrderItem, scheduleLine) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, salesOrderOrEntity instanceof SalesOrderScheduleLine_1.SalesOrderScheduleLine ? salesOrderOrEntity : {
