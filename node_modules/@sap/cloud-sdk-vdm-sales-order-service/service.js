...
class SalesOrderService {
    ...
    get functionImports() {
        return { rejectApprovalRequest: (parameter) => (0, function_imports_1.rejectApprovalRequest)(parameter, this.deSerializers), releaseApprovalRequest: (parameter) => (0, function_imports_1.releaseApprovalRequest)(parameter, this.deSerializers) };
    }
    get batch() {
