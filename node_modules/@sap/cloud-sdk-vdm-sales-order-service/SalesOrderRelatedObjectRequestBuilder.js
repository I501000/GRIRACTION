...
/**
 * Request builder class for operations supported on the [[SalesOrderRelatedObject]] entity.
 */
class SalesOrderRelatedObjectRequestBuilder extends odata_v2_1.RequestBuilder {
     ...
     * @param salesOrder Key property. See [[SalesOrderRelatedObject.salesOrder]].
     * @param sdDocRelatedObjectSequenceNmbr Key property. See [[SalesOrderRelatedObject.sdDocRelatedObjectSequenceNmbr]].
    ...
    delete(salesOrderOrEntity, sdDocRelatedObjectSequenceNmbr) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, salesOrderOrEntity instanceof SalesOrderRelatedObject_1.SalesOrderRelatedObject ? salesOrderOrEntity : {
