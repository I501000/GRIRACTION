...
class SalesOrderItemBillingPlanApi {
    ...
    get schema() {
        const fieldBuilder = new odata_v2_1.FieldBuilder(SalesOrderItemBillingPlan_1.SalesOrderItemBillingPlan, this.deSerializers);
        return {
            /**
         ...
         */
            ...
            /**
             * Static representation of the [[billingPlanIsInHeader]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            BILLING_PLAN_IS_IN_HEADER: fieldBuilder.buildEdmTypeField('BillingPlanIsInHeader', 'Edm.Boolean', true),
            /**
             * Static representation of the [[billingPlanStartDate]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            BILLING_PLAN_START_DATE: fieldBuilder.buildEdmTypeField('BillingPlanStartDate', 'Edm.DateTime', true),
            /**
             * Static representation of the [[billingPlanStartDateRule]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            BILLING_PLAN_START_DATE_RULE: fieldBuilder.buildEdmTypeField('BillingPlanStartDateRule', 'Edm.String', true),
            /**
             * Static representation of the [[referenceBillingPlan]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            REFERENCE_BILLING_PLAN: fieldBuilder.buildEdmTypeField('ReferenceBillingPlan', 'Edm.String', true),
            /**
             * Static representation of the [[billingPlanCategory]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            ...
            /**
             * Static representation of the [[billingPlanEndDate]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            BILLING_PLAN_END_DATE: fieldBuilder.buildEdmTypeField('BillingPlanEndDate', 'Edm.DateTime', true),
            /**
             * Static representation of the [[billingPlanEndDateRule]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            BILLING_PLAN_END_DATE_RULE: fieldBuilder.buildEdmTypeField('BillingPlanEndDateRule', 'Edm.String', true),
            /**
             * Static representation of the [[billingPlanSearchTerm]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
