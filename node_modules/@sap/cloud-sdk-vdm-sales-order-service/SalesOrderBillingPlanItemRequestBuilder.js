...
/**
 * Request builder class for operations supported on the [[SalesOrderBillingPlanItem]] entity.
 */
class SalesOrderBillingPlanItemRequestBuilder extends odata_v2_1.RequestBuilder {
     ...
     * @param salesOrder Key property. See [[SalesOrderBillingPlanItem.salesOrder]].
     * @param billingPlan Key property. See [[SalesOrderBillingPlanItem.billingPlan]].
     * @param billingPlanItem Key property. See [[SalesOrderBillingPlanItem.billingPlanItem]].
    ...
    delete(salesOrderOrEntity, billingPlan, billingPlanItem) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, salesOrderOrEntity instanceof SalesOrderBillingPlanItem_1.SalesOrderBillingPlanItem ? salesOrderOrEntity : {
