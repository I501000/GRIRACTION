...
/**
 * Request builder class for operations supported on the [[SalesOrderText]] entity.
 */
class SalesOrderTextRequestBuilder extends odata_v2_1.RequestBuilder {
     ...
     * @param salesOrder Key property. See [[SalesOrderText.salesOrder]].
     * @param language Key property. See [[SalesOrderText.language]].
     * @param longTextId Key property. See [[SalesOrderText.longTextId]].
    ...
    delete(salesOrderOrEntity, language, longTextId) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, salesOrderOrEntity instanceof SalesOrderText_1.SalesOrderText ? salesOrderOrEntity : {
