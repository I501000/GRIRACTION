...
function rejectApprovalRequest(parameters, deSerializers = odata_v2_1.defaultDeSerializers) {
    ...
    return new odata_v2_1.FunctionImportRequestBuilder('post', '/sap/opu/odata/sap/API_SALES_ORDER_SRV', 'rejectApprovalRequest', (data) => (0, odata_v2_1.transformReturnValueForComplexType)(data, (data) => (0, odata_v2_1.entityDeserializer)(deSerializers).deserializeComplexType(data, FunctionResult_1.FunctionResult)), params, deSerializers);
}
...
function releaseApprovalRequest(parameters, deSerializers = odata_v2_1.defaultDeSerializers) {
    ...
    return new odata_v2_1.FunctionImportRequestBuilder('post', '/sap/opu/odata/sap/API_SALES_ORDER_SRV', 'releaseApprovalRequest', (data) => (0, odata_v2_1.transformReturnValueForComplexType)(data, (data) => (0, odata_v2_1.entityDeserializer)(deSerializers).deserializeComplexType(data, FunctionResult_1.FunctionResult)), params, deSerializers);
}
