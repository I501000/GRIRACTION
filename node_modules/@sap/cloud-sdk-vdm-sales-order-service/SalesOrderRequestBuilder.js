...
/**
 * Request builder class for operations supported on the [[SalesOrder]] entity.
 */
class SalesOrderRequestBuilder extends odata_v2_1.RequestBuilder {
     ...
     * @param salesOrder Key property. See [[SalesOrder.salesOrder]].
     * @returns A request builder for creating requests to retrieve one `SalesOrder` entity based on its keys.
     */
    getByKey(salesOrder) {
        return new odata_v2_1.GetByKeyRequestBuilder(this.entityApi, { SalesOrder: salesOrder });
    }
    /**
    ...
    delete(salesOrderOrEntity) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, salesOrderOrEntity instanceof SalesOrder_1.SalesOrder ? salesOrderOrEntity : { SalesOrder: salesOrderOrEntity });
    }
}
