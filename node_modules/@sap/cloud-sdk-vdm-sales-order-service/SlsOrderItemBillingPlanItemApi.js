...
class SlsOrderItemBillingPlanItemApi {
    ...
    get schema() {
        const fieldBuilder = new odata_v2_1.FieldBuilder(SlsOrderItemBillingPlanItem_1.SlsOrderItemBillingPlanItem, this.deSerializers);
        return {
            /**
         ...
         */
            ...
            /**
             * Static representation of the [[billingPlanItem]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            BILLING_PLAN_ITEM: fieldBuilder.buildEdmTypeField('BillingPlanItem', 'Edm.String', false),
            /**
             * Static representation of the [[billingPlanDateCategory]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            BILLING_PLAN_DATE_CATEGORY: fieldBuilder.buildEdmTypeField('BillingPlanDateCategory', 'Edm.String', true),
            /**
             * Static representation of the [[billingPlanBillingDate]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            BILLING_PLAN_BILLING_DATE: fieldBuilder.buildEdmTypeField('BillingPlanBillingDate', 'Edm.DateTime', true),
            /**
             * Static representation of the [[billingPlanAmount]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            ...
            /**
             * Static representation of the [[billingPlanAmountPercent]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
            ...
            /**
             * Static representation of the [[postponementReason]] property for query construction.
             * Use to reference this property in query operations such as 'select' in the fluent request API.
             */
