...
/**
 * Request builder class for operations supported on the [[SalesOrderItemRelatedObject]] entity.
 */
class SalesOrderItemRelatedObjectRequestBuilder extends odata_v2_1.RequestBuilder {
     ...
     * @param salesOrder Key property. See [[SalesOrderItemRelatedObject.salesOrder]].
     * @param salesOrderItem Key property. See [[SalesOrderItemRelatedObject.salesOrderItem]].
     * @param sdDocRelatedObjectSequenceNmbr Key property. See [[SalesOrderItemRelatedObject.sdDocRelatedObjectSequenceNmbr]].
    ...
    delete(salesOrderOrEntity, salesOrderItem, sdDocRelatedObjectSequenceNmbr) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, salesOrderOrEntity instanceof SalesOrderItemRelatedObject_1.SalesOrderItemRelatedObject ? salesOrderOrEntity : {
