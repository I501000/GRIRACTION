...
/**
 * Request builder class for operations supported on the [[SalesOrderItemPartner]] entity.
 */
class SalesOrderItemPartnerRequestBuilder extends odata_v2_1.RequestBuilder {
     ...
     * @param salesOrder Key property. See [[SalesOrderItemPartner.salesOrder]].
     * @param salesOrderItem Key property. See [[SalesOrderItemPartner.salesOrderItem]].
     * @param partnerFunction Key property. See [[SalesOrderItemPartner.partnerFunction]].
    ...
    delete(salesOrderOrEntity, salesOrderItem, partnerFunction) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, salesOrderOrEntity instanceof SalesOrderItemPartner_1.SalesOrderItemPartner ? salesOrderOrEntity : {
