...
/**
 * Request builder class for operations supported on the [[SalesOrderHeaderPartner]] entity.
 */
class SalesOrderHeaderPartnerRequestBuilder extends odata_v2_1.RequestBuilder {
     ...
     * @param salesOrder Key property. See [[SalesOrderHeaderPartner.salesOrder]].
     * @param partnerFunction Key property. See [[SalesOrderHeaderPartner.partnerFunction]].
    ...
    delete(salesOrderOrEntity, partnerFunction) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, salesOrderOrEntity instanceof SalesOrderHeaderPartner_1.SalesOrderHeaderPartner ? salesOrderOrEntity : {
