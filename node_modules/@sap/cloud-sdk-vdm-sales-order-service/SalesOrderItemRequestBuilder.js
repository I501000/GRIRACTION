...
/**
 * Request builder class for operations supported on the [[SalesOrderItem]] entity.
 */
class SalesOrderItemRequestBuilder extends odata_v2_1.RequestBuilder {
     ...
     * @param salesOrder Key property. See [[SalesOrderItem.salesOrder]].
     * @param salesOrderItem Key property. See [[SalesOrderItem.salesOrderItem]].
    ...
    delete(salesOrderOrEntity, salesOrderItem) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, salesOrderOrEntity instanceof SalesOrderItem_1.SalesOrderItem ? salesOrderOrEntity : {
