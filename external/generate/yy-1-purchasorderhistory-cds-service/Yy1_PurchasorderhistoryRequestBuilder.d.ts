 ...
 */
export declare class Yy1_PurchasorderhistoryRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<Yy1_Purchasorderhistory<T>, T> {
    /**
...
//# sourceMappingURL=Yy1_PurchasorderhistoryRequestBuilder.d.ts.map