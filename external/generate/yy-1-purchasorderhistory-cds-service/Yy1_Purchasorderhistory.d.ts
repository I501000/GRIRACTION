 ...
 */
export declare class Yy1_Purchasorderhistory<T extends DeSerializers = DefaultDeSerializers> extends Entity implements Yy1_PurchasorderhistoryType<T> {
    /**
...
//# sourceMappingURL=Yy1_Purchasorderhistory.d.ts.map